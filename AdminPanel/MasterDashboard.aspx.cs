...
public partial class AdminPanel_MasterDashboard : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        MST_DSBBAL balMST_DSB = new MST_DSBBAL();

        DataTable dtCount = balMST_DSB.SelectTotalIncomeExpense(HospitalID);
        ...
        if (totalIncome > 0)
        {
            DataTable dtDayWiseMonthWiseIncome = balMST_DSB.SelectDayWiseMonthWiseIncome(HospitalID);
        ...
        if (totalExpense > 0)
        {
            DataTable dtDayWiseMonthWiseExpense = balMST_DSB.SelectDayWiseMonthWiseExpense(HospitalID);
        ...
        if (totalPatients > 0)
        {
            DataTable dtTreatmentWiseSummary = balMST_DSB.SelectTreatmentWiseSummary(HospitalID);
