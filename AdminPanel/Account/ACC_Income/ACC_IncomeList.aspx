                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    ...
                                    <asp:LinkButton SkinID="lbtnMultipleDelete" runat="server" CssClass="btn red" OnClick="btnDeleteSelected_Click"></asp:LinkButton>
                                ...
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th class="colspan-2 vertical-align-middle justify-content-center">
                                                        <asp:CheckBox ID="chkSelectAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkSelectAll_CheckedChanged" />


                                                        <asp:Label ID="lbldelete" runat="server" Text="SelectAll"></asp:Label>
                                                    </th>
                                                    <th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="odd gradeX">
                                                            <td class=" vertical-align-middle justify-content-center">
                                                                <asp:HiddenField ID="hfID" runat="server" Value='<%# Eval("IncomeID") %>' />
