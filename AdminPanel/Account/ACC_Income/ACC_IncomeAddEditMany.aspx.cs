    ...
    public partial class AdminPanel_Account_ACC_Income_ACC_IncomeAddEditMany : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                try
                {
                    ...
                    if (balACC_Income.Upsert(xmlData))
                    {
                        ucMessage.ShowSuccess(CommonMessage.RecordSaved());
                        Div_ShowResult.Visible = false;
                        ClearControls();
        ...
        protected void rpData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    CommonFillMethods.FillDropDownListIncomeTypeIDByHospitalID(ddlIncomeTypeID, HospitalID); string incomeTypeID = DataBinder.Eval(e.Item.DataItem, "IncomeTypeID").ToString();
