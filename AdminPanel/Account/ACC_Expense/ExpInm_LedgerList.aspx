...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Expense Income Ledger"></asp:Label>
    <small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtLedgerType" CssClass="form-control" runat="server" PlaceHolder="Enter  Type"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                            ...
                                            <asp:TextBox ID="dtpLedgerFromDate" CssClass="form-control" runat="server" placeholder="Ledger FromDate"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                            ...
                                            <asp:TextBox ID="dtpLedgerToDate" CssClass="form-control" runat="server" placeholder="Ledger ToDate"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th>
                                                        <asp:Label ID="lbhLedgerDate" runat="server" Text="Ledger Date"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhLedgerType" runat="server" Text="Ledger Type"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhLedgerAmount" runat="server" Text="Ledger Amount"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhLedgerNote" runat="server" Text="Ledger Note"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand" OnItemDataBound="rpData_ItemDataBound">
                                                    ...
                                                    <ItemTemplate>
                                                        <%-- Table Rows --%>
                                                        <tr class="odd gradeX" style='<%# Eval("LedgerType").ToString() == "Income" ? "background-color: green; color: white;": "background-color: red; color: white;" %>'>
                                                            <td>
                                                                <%#Eval("LedgerDate") %>
                                                            </td>
                                                            <td>
