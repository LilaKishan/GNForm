...
public partial class AdminPanel_ACC_Expense_ACC_ExpenseList : System.Web.UI.Page
{
    ...
    private void Search(int PageNo)
    {
        ...
        DataTable dt = balACC_Expense.SelectPage(Offset, PageRecordSize, out TotalRecords, ExpenseTypeID,TagName, Amount, ExpenseDate, HospitalID, FinYearID);
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        ACC_ExpenseBAL balACC_Expense = new ACC_ExpenseBAL();
        DataTable dtACC_Expense = balACC_Expense.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, ExpenseTypeID, TagName,Amount, ExpenseDate, HospitalID, FinYearID);
