<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MasterDashboard2.aspx.cs" Inherits="AdminPanel_MasterDashboard_MasterDashboard2" %>
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption font-white">
                        ...
                        <span class="caption-subject bold uppercase">FinYear</span>
                    </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="portlet light">
                                                                        <div class="portlet-title">
                                                                            <div class="caption font-green">
                                                                                <i class="fa fa-line-chart font-green"></i>
                                                                                <span class="caption-subject bold uppercase">Analysis</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="tools ">
                                                                            <ul class="nav nav-tabs">
                                                                                <li class="active">
                                                                                    <asp:LinkButton ID="lbtnCol" runat="server" href=' <%# "#tab_Inc_CategoryWiseIncomeTotalList" + Eval("FinYearID") %>' Text="CategoryWise Income TotalList" data-toggle="tab"></asp:LinkButton>
                                                                                </li>
                                                                                <li class="">
                                                                                    <asp:LinkButton ID="LinkButton3" runat="server" href=' <%# "#tab_Inc_CategoryWiseExpenseTotalList" +  Eval("FinYearID") %>' Text="CategoryWise Expense TotalList" data-toggle="tab"></asp:LinkButton>
                                                                                </li>
                                                                                <li class="">
                                                                                    <asp:LinkButton ID="LinkButton4" runat="server" href=' <%# "#tab_Inc_HospitalWisePatientCountList" + Eval("FinYearID") %>' Text="HospitalWise Patient CountList" data-toggle="tab"></asp:LinkButton>
                                                                                </li>
                                                                                <li class="">
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphScripts" runat="Server">
    ...
    <% for (int i = 0; i < rpFinYear.Items.Count; i++)
        { %>
            drawChart('chart_div_<%= i %>', chartData_<%= i %>);
    <% } %>
        }
