<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="RPT_HospitalWise_DateWiseList.aspx.cs" Inherits="AdminPanel_RPT_RPT_HospitalWise_DateWiseList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="Hospital DateWise Expense Report"></asp:Label>
    </li>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphPageContent" runat="Server">
    ...
    <asp:UpdatePanel ID="upList" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="row">
                <rsweb:ReportViewer ID="rvHospitalWiseDateWiseReport" Visible="false" runat="server" Width="100%" Height="500px">
                    <LocalReport ReportPath="D:\GNWebsoft\GNWebForm3C_CodeB\AdminPanel\RPT\RPT_HospitalWise_DateWiseList.rdlc"></LocalReport>
                </rsweb:ReportViewer>
            </div>
            <div class="row">
                <div class="col-md-12">
