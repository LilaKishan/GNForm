<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="SEC_UserList.aspx.cs" Inherits="AdminPanel_SEC_User_SEC_UserList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
	<asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="User"></asp:Label>
	<small><asp:Label ID="lblPageHeaderInfo_XXXXX" runat="server" Text="Security"></asp:Label></small>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="User"></asp:Label>
    </li>
</asp:Content>
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtUserName" CssClass="First form-control" runat="server"  PlaceHolder="Enter User Name"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                 <div>
									<asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Security/SEC_User/SEC_UserAddEdit.aspx" runat="server"></asp:HyperLink>
                                ...
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th><asp:Label ID="lbhUserName" runat="server" Text="User Name"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhPassword" runat="server" Text="Password"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lblHospital" runat="server" Text="Hospital"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                            <asp:HyperLink ID="hlViewUserID" NavigateUrl='<%# "~/AdminPanel/Security/SEC_User/SEC_UserView.aspx?UserID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("UserID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("UserName") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("Password") %>
                                                            </td>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Security/SEC_User/SEC_UserView.aspx?UserID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("UserID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
								<asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Security/SEC_User/SEC_UserAddEdit.aspx?UserID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("UserID").ToString()) %>' runat="server"></asp:HyperLink>
