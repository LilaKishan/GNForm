...
public partial class AdminPanel_SEC_Menu_SEC_MenuList : System.Web.UI.Page
{ 
    #region 11.0 Variables
	
    String FormName = "SEC_MenuList";
    ...
    private void Search(int PageNo)
    {
        ...
        SqlInt32 ParentMenuID = SqlInt32.Null;
        SqlString MenuName = SqlString.Null;
