<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default/MasterPage.master" CodeFile="DemoList.aspx.cs" Inherits="AdminPanel_Security_Demo_DemoList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="Demo"></asp:Label>
    </li>
</asp:Content>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtDemoName" CssClass="First form-control" runat="server" PlaceHolder="Enter DemoName"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Security/Demo/DemoAddEdit.aspx" runat="server"></asp:HyperLink>
                                    ...
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th>
                                                        <asp:Label ID="lbhDemoName" runat="server" Text="DemoName"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewDemoID" NavigateUrl='<%# "~/AdminPanel/Security/Demo/DemoView.aspx?DemoID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("DemoID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("DemoName") %></asp:HyperLink>
                                                            </td>
                                                            <%--<td>
                                                                <%#Eval("DemoName") %>
                                                            </td>--%>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Security/Demo/DemoView.aspx?DemoID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("DemoID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Security/Demo/DemoAddEdit.aspx?DemoID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("DemoID").ToString()) %>' runat="server"></asp:HyperLink>
                                                                <asp:LinkButton ID="lbtnDelete" runat="server"
                                                                    SkinID="Delete"
                                                                    OnClientClick="javascript:return confirm('Are you sure you want to delete record ? ');"
                                                                    CommandName="DeleteRecord"
                                                                    CommandArgument='<%#Eval("DemoID") %>'>
                                                                </asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                        <%-- END Table Rows --%>
