...
public partial class AdminPanel_Security_Demo_DemoList : System.Web.UI.Page
{

    #region 11.0 Variables

    String FormName = "DemoList";
    ...
    private void Search(int PageNo)
    {
        ...
        SqlString DemoName = SqlString.Null;
        ...
        if (txtDemoName.Text.Trim() != String.Empty)
            DemoName = txtDemoName.Text.Trim();

        #endregion Gather Data

        DemoBAL balDemo = new DemoBAL();

        DataTable dt = balDemo.SelectPage(Offset, PageRecordSize, out TotalRecords, DemoName);
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        DemoBAL balDemo = new DemoBAL();
        DataTable dtDemo = balDemo.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, DemoName);
        if (dtDemo != null && dtDemo.Rows.Count > 0)
        {
            Session["ExportTable"] = dtDemo;
