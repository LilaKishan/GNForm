...
namespace GNForm3C
{
    public class CommonFillMethods
    {
        ...
        public static void FillDropDownListExpenseTypeWithHospitalID(DropDownList ddl)
        {
            ACC_ExpenseBAL balACC_Expense = new ACC_ExpenseBAL();
            ddl.DataSource = balACC_Expense.SelectComboBoxByExpenseTypeWithHospital();
            ddl.DataValueField = "ExpenseTypeID";
            ddl.DataTextField = "ExpenseType";
            ddl.DataBind();
            ddl.Items.Insert(0, new ListItem("Select Expense Type", "-99"));
        ...
        public static void FillDropDownListByIsDefault(DropDownList ddl)
        {
        ...
        {
            // Add "Yes" and "No" items
            ddl.Items.Insert(0, new ListItem("Select CurrentSemester", "-99"));
