    ...
    public class MST_StudentDALBase : DataBaseConfig
    {
        ...
        public Boolean Insert(MST_StudentENT entMST_Student)
        {
            try
            {
                ...
                sqlDB.AddInParameter(dbCMD, "@EmailInstitute", SqlDbType.VarChar, entMST_Student.EmailInstitute);
                sqlDB.AddInParameter(dbCMD, "@EmailPersonal", SqlDbType.VarChar, entMST_Student.EmailPersonal);
                sqlDB.AddInParameter(dbCMD, "@ContactNo", SqlDbType.VarChar, entMST_Student.ContactNo);
                sqlDB.AddInParameter(dbCMD, "@Gender", SqlDbType.VarChar, entMST_Student.Gender);
