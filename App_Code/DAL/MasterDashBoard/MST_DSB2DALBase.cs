...
namespace GNForm3C.DAL
{
    ...
    public class MST_DSB2DALBase : DataBaseConfig
    {
        ...
        #region GetChartData
        //public DataTable GetChartData(int FinYearID)
        //{
        //    try
        //    {
        //        SqlDatabase sqlDB = new SqlDatabase(myConnectionString);
        //        DbCommand dbCMD = sqlDB.GetStoredProcCommand("PR_DSB_IncomeExpenseSumHospitalWise");

        //        DataTable dtCount = new DataTable("PR_DSB_IncomeExpenseSumHospitalWise");
        //        sqlDB.AddInParameter(dbCMD, "@FinYearID", SqlDbType.Int, FinYearID);
